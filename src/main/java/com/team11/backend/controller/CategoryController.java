...
public class CategoryController {
    ...
    public Result<?> categoryList(@RequestBody CategoryDto.RequestDto categoryRequestDto, @PageableDefault(size = 10, sort = "createAt", direction = Sort.Direction.DESC) Pageable pageable) {
